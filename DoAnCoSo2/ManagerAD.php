...
if (isset($_GET['usr'])) {
    $uss = $_GET['usr'];
    $_SESSION['us'] = $_GET['usr'];
    $sql3 = "SELECT * FROM `company` WHERE `username` = '$uss' AND `trangthaichitiet` = 'Chấp Nhận'";
    $sql4 = execute($sql3);

    $sql5 = "SELECT * FROM `blog` WHERE `username` = '$uss' AND `trangthai` = 'Chấp Nhận'";
    $sql6 = execute($sql5);

    $sql7 = "SELECT * FROM `hired` WHERE `username` = '$uss' AND `trangthai` = 'Chấp Nhận'";
    $sql8 = execute($sql7);
} else {
...
<body>
    <div class="">
        <div class="grid poss pdt-50 pdb-50">
            <div class="wide">
                <div class="title_man">
                    <h2><b>Dữ Liệu Của <?= $uss ?>:</b></h2>
                </div>
                <div class="content_man mgt-30 mgl-45">
                    <div class="company">
                        <div class="titlee tl_company fl_xx">
                            <h4 class="animate__animated animate__fadeInLeft"><i class="fa-solid fa-building"></i> Công ty (<?= count($sql4) ?>)</h4>
                    ...
                    <div class="blogg mgt-30">
                        <div class="titlee tl_company fl_xx">
                            <h4 class="animate__animated animate__fadeInLeft"><i class="fa-solid fa-blog"></i> Blog (<?= count($sql6) ?>)</h4>
                            <form class="form_man" method="POST">
                                <span class="iconn"><i class="fa-solid fa-magnifying-glass"></i></span>
                        ...
                        <div class="list_company job-list list2 " id="list__jobs">
                            ...
                            if (count($sql6)) {
                                ...
                                <div class="text-center mgt-25">
                                    <div class="">
                                        <?= $uss ?> chưa đăng tải bất kì blog nào...
                                    </div>
                                </div>
                            <?php }
                            ?>
                    ...
                    <div class="blogg mgt-30">
                        ...
                        <div class="list_company job-list list3" id="list__jobs">
                            ...
                            if (count($sql8)) {
                                ...
                                <div class="text-center mgt-25">
                                    <div class="">
                                        <?= $uss ?> chưa đăng tải bất kì công việc nào...
                                    </div>
                                </div>
                            <?php }
                            ?>
