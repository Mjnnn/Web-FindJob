...
if (isset($_GET['idcv'])) {
    $idd =  $_GET['idcv'];
    $sqll6 = "UPDATE `hired` SET `trangthai`='Đang Chờ Xác Nhận' WHERE `idcongviec`='$idd'";
    $sqll7 = insertA($sqll6);
    if ($sqll3) {
        echo '<script language="javascript">
        alert("Cập nhật thành công!!!");
    </script>';
        header('location: ListHired.php');
    } else {
        echo '<script language="javascript">
...
<head>
    ...
    <title>Danh Sách Các Công Việc Tuyển Dụng</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 centerrr">Danh Sách Các Công Việc Tuyển Dụng</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th><span class="s0">Tổng Số Công Việc</span></th>
                                                ...
                                                <td>
                                                    ...
                                                    if ($sqlll[$i]['trangthai'] == 'Chấp Nhận') { ?>
                                                        <div class="btn btn-success btn-icon-split">
                                                            <span class="text"> <a href="ListHired.php?idcv=<?= $sqlll[$i]['idcongviec'] ?>" class="a1" onclick="return confirm('Bạn Muốn Xem Xét Lại Công Việc: `<?= $sqlll[$i]['nganhnghe']  ?>`')">Đã Chấp Nhận</a></span>
                                                        </div>
                                                    <?php  } else if ($sqlll[$i]['trangthai'] == 'Đang Chờ Xác Nhận') {
                                                        ...
                                                        <div class="btn btn-danger btn-icon-split">
                                                            <span class="text"> <a href="ListHired.php?idcv=<?= $sqlll[$i]['idcongviec'] ?>" class="a1" onclick="return confirm('Bạn Muốn Xem Xét Lại Công Việc: `<?= $sqlll[$i]['nganhnghe']  ?>`')">Đã Từ Chối</a></span>
                                                        </div>
                                                    <?php  } ?>
